...
::: fragment
<iframe 
  src="https://sebastiandres.github.io/pyschool_2025/space_station/rooms/sala_00.html" 
...
::: {style="position: fixed; bottom: -250px; right: -60px; text-align: center;"}
![](images/qr_data.png){width="150px" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.25);"}
:::
