...
6 créditos UTFSM — 183 horas cronológicas
:::
::::
...
- El promedio de los 3 certámenes debe ser **mayor o igual a 45**.
- El promedio de las 3 tareas es la **nota de tareas**.

$$\text{NF} = 0{,}7 \cdot \frac{C_1 + C_2 + C_3}{3} + 0{,}3 \cdot \frac{T_1 + T_2 + T_3}{3}$$
:::
::::::
...
5 créditos UTFSM — 143 horas cronológicas
:::
::::
...
- El promedio de los 3 certámenes debe ser **mayor o igual a 45**.
- El promedio de las 2 tareas es la **nota de tareas**.

$$\text{NF} = 0{,}7 \cdot \frac{C_1 + C_2 + C_3}{3} + 0{,}3 \cdot \frac{T_1 + T_2}{2}$$
