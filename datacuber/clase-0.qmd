...
::: {.column width="40%"}
[Curso de Scikit-Learn](https://www.youtube.com/watch?v=d79mzijMAw0&list=PL_pVmAaAnxIRnSw6wiCpSvshFyCREZmlM) ![](img/clase-0/andreas_mueller.png){.lightbox}
...
![](img/clase-0/tab_data.png){.lightbox fig-align="center"}
...
::: {layout-ncol="2"}
![](img/clase-0/ts_data.png){.lightbox fig-align="center" width="70%"}

![](img/clase-0/ts_plot.png){.lightbox fig-align="center" width="100%"}
:::
...
![](img/clase-0/clustering.png){.lightbox fig-align="center" width="60%"}
...
![](img/clase-0/model.png){.fragment .lightbox fig-align="center" width="60%"}
...
::: {layout-ncol="4"}
![](img/clase-0/correa.png){.fragment fig-align="center" width="50%" fragment-index="1"}

![](img/clase-0/conejo.png){.fragment fig-align="center" width="50%" fragment-index="3"}

![](img/clase-0/cuchillo.png){.fragment fig-align="center" width="50%" fragment-index="5"}

![](img/clase-0/bicicleta.png){.fragment fig-align="center" width="50%" fragment-index="7"}
:::
...
::: {layout-ncol="3"}
![`K`u`ch`illo](img/clase-0/cuchillo.png){.fragment .fade-out fig-align="center" width="70%" fragment-index="2"}
...
[Tics-411 Minería de Datos]{property="dct:title"} está licenciado bajo <a href="http://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer" style="display:inline-block;">CC BY-NC-SA 4.0
